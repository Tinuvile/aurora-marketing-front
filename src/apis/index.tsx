// 请求地址
const apiHostUrl = process.env.API_HOST_URL ? process.env.API_HOST_URL : "https://mock.apipost.net/mock/438faf5064e0000";
...
export const queryRaffleAwardList = (strategyId: number) => {
    try {
        /*
        return fetch(`${apiHostUrl}/api/v1/raffle/query_raffle_award_list?apipost_id=${process.env.API_POST_ID}&strategyId=${strategyId}`, {
            method: 'get',
        */
...
export const randomRaffle = (strategyId: number) => {
    try {
        /*
        return fetch(`${apiHostUrl}/api/v1/raffle/random_raffle?apipost_id=${process.env.API_POST_ID}&strategyId=${strategyId}`, {
            method: 'get',
            */
